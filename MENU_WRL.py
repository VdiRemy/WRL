...
def CAPTURA_DATASET(inp_menu):
    from FUNCOES_CAPTURA_DATASET import aba_captura_dataset
    janela_captura_dataset = aba_captura_dataset(inp_menu)
    janela_captura_dataset.deiconify()
